...
if (isset($_GET['action']) && $_GET['action'] == 'updateObat') {
    ...
    if (!isset($stok_keluar) || $stok_keluar === '') {
        $emptyFields[] = 'stok_keluar';
    }
    

    if (empty($emptyFields)) {
        updateDataPengeluaranObat($id, $tanggal, $idObat, $stok_keluar);
        $_SESSION['flash_message'] = [
            'type' => 'success',
            'message' => 'Data updated successfully.'
        ];
        header("Location: pengeluaran_obat.php?success=1");
    } else {
        $_SESSION['flash_message'] = [
            'type' => 'danger',
            'message' => 'Missing data in the following field(s): ' . implode(', ', $emptyFields)
        ];
        header("Location: pengeluaran_obat.php?success=0");
        exit();
    }
}
...
$dataAnalgetik = getPengeluaranObatDataAnalgetik();
$dataAntibiotic = getPengeluaranObatDataAntibiotic();
$dataGigi = getPengeluaranObatDataGigi();
$dataReagentLab = getPengeluaranObatDataReagentLab();
...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Pengeluaran Data Obat</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">Pengeluaran Data Obat</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
...
<div class="card">
    ...
    <div class="card-body">
        <div class="mb-3">
            ...
            <a class="btn btn-danger" href="report/obat_keluar/reportObatAnalgetik.php">Cetak Obat Analgetik</a>
        ...
        <tbody>
            <?php foreach ($dataAnalgetik as $obat) : ?>
                <tr>
                    ...
                    <td><?php echo $obat['stok_keluar']; ?></td>
                    <td>
                        <a href="#" class="btn btn-primary btn-edit" data-id="<?php echo $obat['id']; ?>" data-tanggal="<?php echo $obat['tanggal']; ?>" data-nama-obat="<?php echo $obat['nama_obat']; ?>" data-jumlah="<?php echo $obat['stok_keluar']; ?>" data-id>Edit</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
             ...
             <a class="btn btn-danger" href="report/obat_keluar/reportObatAntibiotic.php">Cetak Obat Antibiotic</a>
        ...
        <tbody>
            <?php foreach ($dataAntibiotic as $obat) : ?>
                <tr>
                    ...
                    <td><?php echo $obat['stok_keluar']; ?></td>
                    <td>
                        <a href="#" class="btn btn-primary btn-edit" data-id="<?php echo $obat['id']; ?>" data-tanggal="<?php echo $obat['tanggal']; ?>" data-nama-obat="<?php echo $obat['nama_obat']; ?>" data-jumlah="<?php echo $obat['stok_keluar']; ?>">Edit</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
             ...
             <a class="btn btn-danger" href="report/obat_keluar/reportObatGigi.php">Cetak Obat Gigi</a>
        ...
        <tbody>
            ...
            <?php endforeach; ?>
             ...
             <a class="btn btn-danger" href="report/obat_keluar/reportObatReagentLab.php">Cetak Obat Reagent Lab</a>
...
<div class="modal fade" id="editObatModal" tabindex="-1" aria-labelledby="editObatModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="pengeluaran_obat.php?action=updateObat" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="edit_jumlah">Stok Keluar</label>
                        <input type="number" class="form-control" id="edit_jumlah" name="stok_keluar" required>
                    </div>
                </div>
